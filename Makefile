...
APP_LOAD_FLAGS= --appFlags 0x40 --dep APIS:$(APPVERSION)
...
DEFINES += CHAINID_UPCASE=\"APIS\" CHAINID_COINNAME=\"APIS\" CHAIN_KIND=CHAIN_KIND_APIS CHAIN_ID=0
APPNAME = "APIS"
DEFINES_LIB=
...
ICONNAME=blue_app_apis.gif
else
ICONNAME=nanos_app_apis.gif
endif
